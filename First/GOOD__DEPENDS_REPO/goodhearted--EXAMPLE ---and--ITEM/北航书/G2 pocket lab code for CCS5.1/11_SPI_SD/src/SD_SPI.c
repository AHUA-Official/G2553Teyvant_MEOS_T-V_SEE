...
* 出口参数：0：写入失败
* 					1：写入成功
* 使用范例：SD_Write_Sector(83241,buffer,100,200); 	 //向扇区83241中写入100个字节
************************************************************************************************************/
...
//	unsigned char pTemp= SD_EMPTY_DATA;
...
* 出口参数：0：读取失败
* 					1：读取成功
* 使用范例：SD_Read_Sector(83241,buffer,100,200); 	 //从扇区83241中读出100个字节，放入buffer中
************************************************************************************************************/
